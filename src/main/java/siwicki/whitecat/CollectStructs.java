 ...
 */
public class CollectStructs extends AbstractGenericUDAFResolver {
    static final Log LOG = LogFactory.getLog(CollectStructs.class.getName());
    ...
    public GenericUDAFEvaluator getEvaluator(GenericUDAFParameterInfo info) throws SemanticException {
        ...
        public static class CollectStructEvaluator extends GenericUDAFEvaluator {
            ...
            private StandardStructObjectInspector inputOI;
            ...
            public ObjectInspector init(Mode m, ObjectInspector[] parameters) throws HiveException {
                ...
                if(m == Mode.PARTIAL1) {
                    ...
                    return ObjectInspectorFactory.getStandardListObjectInspector(
                            (StandardStructObjectInspector) ObjectInspectorUtils
                    ...
                    if (!(parameters[0] instanceof StandardListObjectInspector)) {
                        ...
                        inputOI = (StandardStructObjectInspector)
